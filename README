...
It only works for Retail and contains all the raids up to BfA (Battle for Azeroth). This is due to the addon being developed for the purpose of Transmog and Mount runs in old raids.
